    ...
    return (
      <div className="app-page">
        <div className="mx-auto max-w-3xl rounded-2xl border border-green-200 bg-white p-6 text-center shadow-sm sm:p-8">
          ...
          <h1 className="mt-5 text-2xl font-bold text-gray-900">Pedido de reposicion enviado</h1>
          <p className="mt-2 text-gray-600">
            Se registro la solicitud para {confirmedOrder.length} productos y {confirmedOrder.reduce((sum, item) => sum + item.quantity, 0)} unidades.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
            ...
            <button
              ...
              className="rounded-lg border border-gray-300 px-5 py-3 font-medium text-gray-700 transition-colors hover:bg-gray-50"
            >
              Crear otro pedido
            </button>
          </div>
