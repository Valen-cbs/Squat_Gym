...
import { ArrowLeft, CheckCircle, FileSearch, ShieldCheck, XCircle } from "lucide-react";
import { getClaimById, PaymentClaim } from "../../data/reclamos";
          ...
          <div className="space-y-3">
            <div className="rounded-2xl border border-slate-200 bg-white p-4">
              ...
              <p className="mt-2 text-sm text-slate-700">
                Revisa el comprobante y confirma si debe conciliarse con caja o solicitar respaldo.
              </p>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <button className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-green-600 px-4 py-3 text-sm font-semibold text-white hover:bg-green-700">
