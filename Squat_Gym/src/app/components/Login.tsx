...
import { User, Lock, Dumbbell, Shield, Briefcase, Users, ArrowRight, AlertCircle } from "lucide-react";
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (touched.email) setErrors((prev) => ({ ...prev, email: e.target.value.trim() ? undefined : "El usuario o correo es obligatorio" }));
                      }}
                      onBlur={() => handleBlur("email")}
                      placeholder="Ingresa tu usuario o correo"
                      className={`w-full rounded-2xl border py-3 pl-10 pr-4 text-slate-900 outline-none transition focus:ring-4 ${
                        touched.email && errors.email
                          ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-red-100"
                          : "border-slate-300 bg-slate-50 focus:border-blue-500 focus:bg-white focus:ring-blue-100"
                      }`}
                    />
                  </div>
                  {touched.email && errors.email && (
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (touched.password) setErrors((prev) => ({ ...prev, password: e.target.value.trim() ? undefined : "La contraseña es obligatoria" }));
                      }}
